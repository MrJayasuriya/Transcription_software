...
def render_transcription_chat(session_data):
...
def render_session_table_with_filters():
        ...
        with st.expander(
            ...
            with col1:
                ...
                if session['status'] == 'completed':
                    ...
                    with col_btn1:
                        if st.button(f"👁️ View", key=f"view_{session['id']}"):
            ...
            with col2:
                ...
                if (st.session_state.selected_session_id == session['id'] or 
                    ...
                    if session_data:
                        render_transcription_chat(session_data)
...
def render_session_history():
    ...
    render_session_table_with_filters()
